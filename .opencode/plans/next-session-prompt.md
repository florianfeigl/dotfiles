...
- **dotfiles** (`git@github.com:florianfeigl/dotfiles.git`): Von GNU Stow auf chezmoi migriert. Chezmoi Source liegt unter `~/.local/share/chezmoi/`. Catppuccin Macchiato als globales Theme. Alacritty ist Standard-Terminal.
